  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-cream via-white to-amber-50 flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        <div className="mb-8">
          <div className="w-32 h-32 bg-brand-nude/50 rounded-full flex items-center justify-center mx-auto mb-6">
            <i className="ri-tools-line text-6xl text-brand-espresso"></i>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="w-12 h-12 bg-brand-nude/50 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-rocket-line text-2xl text-brand-espresso"></i>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="w-12 h-12 bg-brand-nude/50 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-shield-check-line text-2xl text-brand-espresso"></i>
            </div>
        ...
        <div className="bg-brand-nude/30 border border-brand-nude/70 rounded-2xl p-8 mb-8">
