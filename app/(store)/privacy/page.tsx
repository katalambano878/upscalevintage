        ...
        <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <i className="ri-shopping-bag-line text-brand-espresso"></i>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <i className="ri-line-chart-line text-brand-espresso"></i>
                  Service Improvement
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <i className="ri-mail-line text-brand-espresso"></i>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <i className="ri-shield-check-line text-brand-espresso"></i>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <i className="ri-scales-line text-brand-espresso"></i>
                  Legal Compliance
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-brand-espresso pl-6">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-brand-nude/30 border border-brand-nude/70 p-6 rounded-xl">
                <div className="w-10 h-10 bg-brand-espresso rounded-full flex items-center justify-center mb-4">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-brand-nude/50 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-eye-line text-brand-espresso"></i>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-brand-nude/50 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-pencil-line text-brand-espresso"></i>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-brand-nude/50 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-delete-bin-line text-brand-espresso"></i>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-brand-nude/50 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-mail-close-line text-brand-espresso"></i>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-brand-nude/50 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-download-line text-brand-espresso"></i>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-brand-nude/50 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-hand-coin-line text-brand-espresso"></i>
                </div>
                <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              To exercise any of these rights, please contact us at <a href={`mailto:${SUPPORT_EMAIL}`} className="text-brand-espresso font-medium hover:underline">{SUPPORT_EMAIL}</a> or through your account settings. We will respond within 30 days.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 text-gray-600">
              <li className="flex items-start gap-2">
                <i className="ri-arrow-right-s-line text-brand-espresso mt-1"></i>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-50 border border-gray-200 p-8 rounded-xl">
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <i className="ri-map-pin-line text-brand-espresso text-xl mt-1"></i>
                  <div>
