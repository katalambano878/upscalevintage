...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <main className="min-h-screen bg-brand-cream flex items-center justify-center py-12 px-4 sm:px-6">
        <div className="max-w-md w-full text-center">
          <div className="w-20 h-20 bg-brand-nude/50 rounded-full flex items-center justify-center mx-auto mb-6">
            <i className="ri-mail-send-line text-4xl text-brand-espresso"></i>
          </div>
          ...
          <Link href="/auth/login" className="inline-block bg-brand-espresso text-white px-8 py-3 rounded-lg font-semibold hover:bg-brand-cocoa transition-colors">
            Back to Login
          </Link>
        </div>
      </main>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-12 border-2 rounded-lg focus:ring-2 focus:ring-brand-mauve/40 focus:border-brand-espresso ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'
                    }`}
            ...
            <div>
              <label className="flex items-start space-x-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 mt-1 text-brand-espresso rounded focus:ring-brand-mauve/40"
                />
                <span className="text-sm text-gray-700">
                  I agree to the{' '}
                  <Link href="/terms" className="text-brand-espresso hover:text-brand-espresso font-medium whitespace-nowrap">
                    Terms & Conditions
                  </Link>
                  {' '}and{' '}
                  <Link href="/privacy" className="text-brand-espresso hover:text-brand-espresso font-medium whitespace-nowrap">
                    Privacy Policy
                  </Link>
                </span>
              </label>
            ...
            <button
              ...
              className="w-full bg-brand-espresso hover:bg-brand-cocoa text-white py-4 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap cursor-pointer"
            >
              {isLoading || verifying ? (
          ...
          <p className="mt-8 text-center text-gray-600">
            ...
            <Link href="/auth/login" className="text-brand-espresso hover:text-brand-espresso font-semibold whitespace-nowrap">
              Sign in
            </Link>
          </p>
        </div>
