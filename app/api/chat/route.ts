...
- Delivery: see /shipping; estimates shown at checkout. Standard 1-3 days in Accra, 3-7 days outside.
- Returns: see /returns; refunds for defective/damaged items, mix-ups, or sold-out items. Exchanges within 24 hours, original packaging required.
- Payment: Moolre Mobile Money (GHS); COD only when explicitly offered.
...
3. Ask them to choose a delivery method:
   ...
   - **Pickup** — Free (collect from our Accra shop)
4. Ask them to choose a payment method:
   - **Moolre** — Mobile Money via secure Moolre link (recommended)
